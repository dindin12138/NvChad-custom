...
M.lspconfig = {
    ...
    n = {
        ...
        ["gp"] = { function() vim.lsp.buf.implementation() end, "lsp implementation" },
        ...
        ["gr"] = { function() require("nvchad_ui.renamer").open() end, "lsp rename" },
        ["ga"] = { function() vim.lsp.buf.code_action() end, "lsp code_action" },
        ["gl"] = { function() vim.lsp.buf.references() end, "lsp references" },
